...
DATABASE_NAME = environ.get('DATABASE_NAME', "Clustero")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Benzmawa') # owner username without @
...
# Shortlink Info
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://shrinkearn.com')
